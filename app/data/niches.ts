...
export const niches: Niche[] = [
  ...
  // ===========================================================================
  {
    ...
    category: "turismo",
    nicheNoun: "transfer",
    seoTitle: "Transfer em Foz do Iguaçu: como se locomover | Compras Paraguay",
    seoDescription:
      "Transporte para as Cataratas, Parque das Aves, Compras no Paraguai, Feirinha na Argentina, sem depender de aplicativo nem perder tempo entre os passeios.",
    keywords: [
    ...
    h1: "Passeios e roteiros sem complicação",
    heroLead: [
      "Os atrativos de Foz do Iguaçu são incríveis, mas estão distribuídos por uma região que cruza fronteiras. Sem organização, é fácil perder tempo, ingresso ou o melhor horário de cada lugar.",
    ],
    heroCta: "Ver transfer",
    recommendationEyebrow: "A escolha da nossa equipe",
    recommendationTitle: "A nossa recomendação de transfer em Foz do Iguaçu",
    recommendationLead:
      "Avaliamos atendimento, pontualidade e confiança. Para os seus dias em Foz renderem sem estresse, este é o transfer que a nossa equipe indica na cidade.",
    sections: [
      {
        eyebrow: "Como escolher",
        icon: "ShieldCheck",
        heading: "O que um bom transfer oferece",
        headingDestaque: "transfer",
        paragraphs: [
          "Nem todo transfer é igual. Os melhores unem pontualidade, veículos confortáveis e transparência — você sabe exatamente o que está contratando, sem taxas escondidas. Motoristas experientes e conhecimento real da região fazem toda a diferença na qualidade do passeio.",
        ],
        bullets: [
          ...
          { icon: "Users", title: "Ajuste ao seu roteiro", text: "Horário de chegada, atrativo do dia, grupo, família ou casal: o transfer se adapta ao seu ritmo." },
          { icon: "Star", title: "Motoristas que conhecem", text: "Quem dirige em Foz conhece os horários de pico das Cataratas e o melhor caminho para cada atrativo." },
        ],
        closing:
          "Vale checar a reputação, a cobertura de rotas (das Cataratas aos passeios menos óbvios) e o suporte durante o passeio. Um transfer confiável se antecipa aos imprevistos e adapta o programa ao seu ritmo — seja em família, em casal ou em grupo.",
      },
    ],
    faq: [
      { q: "Vale a pena contratar transfer em Foz do Iguaçu?", a: "Para a maioria dos visitantes, sim. Os atrativos ficam espalhados por uma região que cruza fronteiras, e o transfer resolve o transporte entre o hotel e cada passeio, poupando tempo e evitando dor de cabeça. A recomendação da nossa equipe nesta página prioriza operadoras locais pontuais e confiáveis." },
      { q: "Quanto custa um transfer em Foz do Iguaçu?", a: "O valor varia conforme a distância, o horário e o tamanho do grupo. Muitas operadoras oferecem condições que já incluem o transporte de ida e volta até os atrativos, o que costuma sair mais prático. O ideal é conferir as condições direto com a operadora recomendada." },
      ...
      { q: "O transfer leva até quais atrativos em Foz?", a: "Os clássicos são as Cataratas do lado brasileiro e argentino, Itaipu, o Parque das Aves e o Marco das Três Fronteiras, além das compras no Paraguai. Boas operadoras ajudam ainda a encaixar Macuco Safari, Duty Free, a Feirinha e o lazer temático no roteiro." },
      { q: "O transfer ajuda a organizar o roteiro dos meus dias em Foz?", a: "Sim. Uma boa operadora monta um programa fluido, encaixando os grandes atrativos de dia e experiências de fim de tarde — como o Marco das Três Fronteiras — para coroar o passeio sem você se preocupar com transporte e horários." },
    ],
    datePublished: "2026-07-03",
    dateModified: "2026-07-03",
